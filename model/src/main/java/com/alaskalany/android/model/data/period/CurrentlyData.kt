...
data class CurrentlyData @JvmOverloads constructor(
    override val time: Time = Time(),
    override val summary: Summary = Summary(),
    override val icon: ForecastIconType = ForecastIconType(),
    override val nearestStormDistance: NearestStormDistance = NearestStormDistance(),
    ...
    HasTemperature, HasNearestStormDistance